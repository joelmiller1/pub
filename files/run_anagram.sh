...
/usr/bin/time -a -o ./outorder/runtime.txt $SIM -fetch:ifqsize $1 -decode:width $1 -issue:width $1 -commit:width $1 -res:ialu $2 -res:imult $3 -res:memport $4 -issue:inorder $5 -redir:sim "./outorder/go_stdout_$1_$2_$3_$4_$5.txt" anagram.ss words < anagram.in > ./outorder/go_output_$1_$2_$3_$4_$5.txt
echo "done"
echo "running diff on go in-order=$5 width $1, intalu $2, intmult $3, memprt $4"
diff ./outorder/go_output_$1_$2_$3_$4_$5.txt anagram.out
...
/usr/bin/time -a -o ./pred/runtime.txt $SIM -fetch:ifqsize 4 -decode:width 4 -issue:width 4 -commit:width 4 -res:ialu 3 -res:imult 2 -res:memport 2 -issue:inorder $1 -bpred $2 -redir:sim "./pred/pred_$2_$1.txt" anagram.ss words < anagram.in > ./pred/pred_output_$2_$1.txt
echo "done"
echo "running diff on go in-order=$1, bpred=$2"
diff ./pred/pred_output_$2_$1.txt anagram.out
echo "done with diff check"
date
}
