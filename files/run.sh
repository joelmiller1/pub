...
/usr/bin/time -a -o runtime.txt $SIM -fetch:ifqsize $1 -decode:width $1 -issue:width $1 -commit:width $1 -res:ialu $2 -res:imult $3 -res:memport $4 -issue:inorder $5 -redir:sim "go_stdout_$1_$2_$3_$4_$5.txt" go.ss 50 9 2stone9.in > go_output_$1_$2_$3_$4_$5.txt
echo "done"
...
/usr/bin/time -a -o runtime.txt $SIM -fetch:ifqsize 4 -decode:width 4 -issue:width 4 -commit:width 4 -res:ialu 3 -res:imult 2 -res:memport 2 -issue:inorder $1 -bpred $2 -redir:sim "pred_$2_$1.txt" go.ss 50 9 2stone9.in > pred_output_$2_$1.txt
echo "done"
