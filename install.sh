...
curl -sSL https://github.com/joelmiller1/pub/raw/main/files/CSCE692Project.tgz
curl -sSL https://github.com/joelmiller1/pub/raw/main/files/simplesim-3v0e.tgz
